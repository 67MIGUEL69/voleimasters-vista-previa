...
const CONFIG = {
  ...
  /* Cada quants segons es demana el marcador dels partits en directe.
     ...
     Tres: qui mira el marcador des de casa vol veure el punt gairebé
     quan passa, i la petició és petita —el servidor només torna el que
     ha canviat des de l'última vegada, i si no s'ha mogut res arriba
     buida. */
  segonsSondeig: 3,
